...
(function(){(function(c){function g(){return"ontouchstart"in window||"onmsgesturechange"in window}function h(a,b){this.d=c.extend(this.g,b);this.b=c(a);this.i()}function l(){this.top=this.left=0}function k(a,b,d){clearTimeout(Number(c(a).data("am-delay")));b&&d&&c(a).data("am-delay",setTimeout(c.proxy(b,a),d))}h.prototype={g:{focusClass:"menuitem-focus",visibleMenuClass:"show-menu",closeDelay:100},a:{k:function(){},l:function(a){var b=c(this).parent().find(">ul>li>a").first();b.length&&(b.focus(),a.preventDefault())},
