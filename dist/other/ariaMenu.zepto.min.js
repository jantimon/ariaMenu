...
(function(){(function(c){function f(){return"ontouchstart"in window||"onmsgesturechange"in window}function h(a,b){this.d=c.extend(this.g,b);this.b=c(a);this.i()}function k(){this.top=this.left=0}function g(a,b,d){clearTimeout(Number(c(a).data("am-delay")));b&&d&&c(a).data("am-delay",setTimeout(c.proxy(b,a),d))}h.prototype={g:{focusClass:"menuitem-focus",visibleMenuClass:"show-menu",closeDelay:100},a:{k:function(){},l:function(a){c(this).parent().find(">ul").length&&(c(this).focus(),a.preventDefault())},p:function(){c(this).focus()},
